...
import com.taolu.shop.utils.GeometryUtil;
import com.taolu.shop.utils.LogUtil;
import com.taolu.shop.utils.Utils;
...
public class GooView extends View {
	...
	public GooView(Context context) {
		...
		LogUtil.e("farest","farest....."+farest);
		//40f
		resetDistance = Utils.dip2Dimension(40.0f, getContext());
		LogUtil.e("resetDistance",resetDistance+"....");
...
//		path.addCircle((float)stickPoints[1].x, (float)stickPoints[1].y, 5, Direction.CW);
	...
	private void handleActionUp() {
		LogUtil.e("ccc","handactionup"+isOutOfRange);
		if(isOutOfRange){
			...
			mAnim.addListener(new AnimatorListenerAdapter() {
				...
				public void onAnimationEnd(Animator animation) {
					if(mListener != null)
						LogUtil.e("ttt","动画结束了"+isOutOfRange);
