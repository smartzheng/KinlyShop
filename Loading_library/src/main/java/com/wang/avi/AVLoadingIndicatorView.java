...
public class AVLoadingIndicatorView extends View {
    ...
    private void init(Context context,AttributeSet attrs,int defStyleAttr, int defStyleRes) {
        ...
        mMin_Width = a.getDimensionPixelSize(R.styleable.AVLoadingIndicatorView_min_Width, mMin_Width);
        mMaxWidth = a.getDimensionPixelSize(R.styleable.AVLoadingIndicatorView_maxWidth, mMaxWidth);
        mMin_Height = a.getDimensionPixelSize(R.styleable.AVLoadingIndicatorView_min_Height, mMin_Height);
    ...
    protected synchronized void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        final Drawable d = mIndicator;
        if (d != null) {
            dw = Math.max(mMin_Width, Math.min(mMaxWidth, d.getIntrinsicWidth()));
            dh = Math.max(mMin_Height, Math.min(mMaxHeight, d.getIntrinsicHeight()));
        }
